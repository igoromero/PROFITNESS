...
import br.edu.ifba.plugin.PROFITNESS.modelo.bd.estatico.UsuarioDAO;
import br.edu.ifba.plugin.PROFITNESS.modelo.bd.jpa.UsuarioSagu;
import br.edu.ifba.plugin.PROFITNESS.modelo.bd.jpa.UsuarioSaguDAO;
import br.edu.ifba.plugin.PROFITNESS.visao.IAcessoUsuario;
import br.edu.ifba.plugin.PROFITNESS.visao.ICadastroUsuario;
import br.edu.ifba.plugin.PROFITNESS.visao.IPesquisaUsuario;
		...
		if (!criterio.equals("")) {
			...
			if (!criterio.equals("")) {
				...
				if (!criterio.equals("")) {
					...
					criterio = pesquisaUsuario.getCargo();
					System.out.print(criterio);
					if(!criterio.equals("")){
						usuarios = UsuarioDAO.getUsuarioPorCargo(criterio);
					}
				}
			}
		}
